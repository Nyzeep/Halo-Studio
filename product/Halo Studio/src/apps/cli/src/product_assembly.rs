...
mod tests {
    ...
    use halo_core::product_assembly::ProductServiceCapabilityStatus;
    use halo_core::product_assembly::{product_assembly_plan_for_profile, DeliveryProfile};
    use halo_core::product_runtime::build_local_runtime_services;
