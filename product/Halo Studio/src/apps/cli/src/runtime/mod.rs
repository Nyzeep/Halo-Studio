...
use halo_core::agentic::system::AgenticSystem;
use halo_core::product_assembly::{ProductAssemblyPlan, ProductServiceCapabilityAvailability};
...
use halo_runtime_ports::LocalWorkspaceSnapshotPort;
