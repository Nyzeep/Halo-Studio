...
mod tests {
    ...
    fn element_token_register_format_resolve_round_trip() {
        use halo_agent_tools::element_token;
    ...
    fn element_token_resolve_element_args_precedence() {
        use halo_agent_tools::element_token::{self, ResolvedElement};
    ...
    fn complete_flow_type_compatibility() {
        ...
        use halo_core::agentic::tools::computer_use_host::{AppInfo, AppStateSnapshot, AxNode};
