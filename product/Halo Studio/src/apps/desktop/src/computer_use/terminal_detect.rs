...
//! (`platform-macos/src/terminal.rs`) and Halo's existing macOS pid-based
...
/// match. Union of the cua-driver-rs list and Halo's existing
...
const MACOS_TERMINAL_BUNDLE_IDS: &[&str] = &[
    ...
    "io.wez.wezterm",                // WezTerm (Halo id)
