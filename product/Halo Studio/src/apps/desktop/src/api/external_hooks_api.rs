...
use halo_core::external_sources::ExternalSourceOperationResult;
...
pub async fn plan_external_hook_import_command(
    ...
    let workspace =
        super::external_sources_api::require_local_workspace(request.workspace_path.as_deref())
            .await?;
    halo_core::external_hook_import::plan_external_hook_import(workspace, request.source).await
}
...
pub async fn apply_external_hook_import_command(
    ...
    let workspace =
        super::external_sources_api::require_local_workspace(request.workspace_path.as_deref())
            .await?;
    halo_core::external_hook_import::apply_external_hook_import(workspace, request.import_request)
        .await
}
...
pub async fn mutate_external_hook_import_command(
    ...
    let workspace =
        super::external_sources_api::require_local_workspace(request.workspace_path.as_deref())
            .await?;
    halo_core::external_hook_import::mutate_external_hook_import(workspace, request.mutation)
        .await
}
