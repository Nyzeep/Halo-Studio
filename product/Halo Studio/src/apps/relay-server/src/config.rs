...
impl Default for RelayConfig {
    fn default() -> Self {
        Self {
            ...
            static_dir: None,
            // Also stores published Halo Pages under `{room_web_dir}/pages/{user_id}/{slug}/`.
            room_web_dir: "/tmp/halo-room-web".to_string(),
            asset_store_max_bytes: halo_relay_service::DEFAULT_DISK_ASSET_STORE_MAX_BYTES,
