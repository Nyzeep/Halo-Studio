...
const HaloCanvasPanel = React.lazy(() =>
  import('@/tools/halo-canvas/HaloCanvasPanel')
);
...
const FlexiblePanel: React.FC<ExtendedFlexiblePanelProps> = memo(({
  ...
  const renderEditorLoading = () => (
    <div className="halo-flexible-panel__loading">
      {t('select.loading')}
    </div>
  );
  ...
  const renderContent = () => {
    if (!content || content.type === 'empty') {
      return (
        <div className="halo-flexible-panel__empty-content">
          <div className="halo-flexible-panel__empty-icon">
    ...
    switch (content.type) {
      case 'code-preview': {
        ...
        return (
          <div className={`halo-flexible-panel__code-content ${hasFixNeeded ? 'needs-fix' : ''}`}>
      ...
      case 'markdown-viewer':
        return (
          <div className="halo-flexible-panel__markdown-content">
      ...
      case 'markdown-editor': {
        ...
        return (
          <div className="halo-flexible-panel__markdown-editor">
            {markdownFilePath || markdownInitialContent !== undefined ? (
              ...
              <div className="halo-flexible-panel__error-message">
                <AlertCircle size={20} />
      ...
      case 'text-viewer':
        return (
          <div className="halo-flexible-panel__text-content">
      ...
      case 'file-viewer': {
        ...
        const fileViewerClass = `halo-flexible-panel__panel-code-viewer ${fileNeedsFix ? 'needs-fix' : ''}`;
        
        return (
          <div className="halo-flexible-panel__code-viewer-container">
            {renderLazyEditor(
              <CodeEditor
      ...
      case 'image-viewer': {
        ...
        return (
          <div className="halo-flexible-panel__image-viewer-container">
            {renderLazyEditor(
              <ImageViewer
                filePath={imageViewerData.filePath || ''}
                fileName={content.title}
                workspacePath={workspacePath}
                className="halo-flexible-panel__image-viewer"
              />
            )}
          </div>
        );
      ...
      case 'code-viewer': {
        ...
        return (
          <div className="halo-flexible-panel__code-viewer-container">
            <div className={`halo-flexible-panel__code-content ${needsFix ? 'needs-fix' : ''}`}>
              {renderLazyEditor(
                <CodeEditor
      ...
      case 'task-detail': {
        ...
        return (
          <React.Suspense fallback={<div className="halo-flexible-panel__loading">{t('flexiblePanel.loading.taskDetail')}</div>}>
      ...
      case 'plan-viewer': {
        ...
        return (
          <React.Suspense fallback={<div className="halo-flexible-panel__loading">{t('flexiblePanel.loading.planViewer')}</div>}>
            <PlanViewer
      ...
      case 'terminal': {
        ...
        return (
          <React.Suspense fallback={<div className="halo-flexible-panel__loading">{t('flexiblePanel.loading.terminal')}</div>}>
            <div className="halo-flexible-panel__terminal-container">
              <TerminalTabPanel
                key={sessionId}
                sessionId={sessionId}
                autoFocus={true}
      ...
      case 'review-platform':
        return (
          <React.Suspense fallback={<div className="halo-flexible-panel__loading">Loading pull requests...</div>}>
      ...
      case 'review-platform-pr-detail':
        return (
          <React.Suspense fallback={<div className="halo-flexible-panel__loading">Loading pull request...</div>}>
            <ReviewPlatformPanel
              workspacePath={content.data?.workspacePath || workspacePath}
      ...
      case 'generative-widget':
        return (
          <React.Suspense fallback={<div className="halo-flexible-panel__loading">Loading widget preview...</div>}>
      ...
      case 'halo-canvas':
        return (
          <React.Suspense fallback={<div className="halo-flexible-panel__loading">Loading Canvas preview...</div>}>
            <HaloCanvasPanel
              title={content.title}
      ...
      default:
        return (
          <div className="halo-flexible-panel__unknown-content">
            <div className="halo-flexible-panel__unknown-icon">
              <AlertCircle size={48} />
            </div>
            <h3>{t('flexiblePanel.unknownContent.title')}</h3>
            <p>{t('flexiblePanel.unknownContent.description')}</p>
            <div className="halo-flexible-panel__unknown-meta">
  ...
  return (
    <div className={`halo-flexible-panel ${className}`}>
      {showHeader && (
        <div className="halo-flexible-panel__header">
          <div className="halo-flexible-panel__header-left">
            <div className="halo-flexible-panel__content-icon">
              {getContentIcon(content.type)}
            </div>
            <div className="halo-flexible-panel__content-info">
              <span className="halo-flexible-panel__content-title">
                {content.title || getContentTypeName(content.type)}
              </span>
              <span className="halo-flexible-panel__content-type">
                {getContentTypeName(content.type)}
              </span>
            </div>
          </div>

          <div className="halo-flexible-panel__header-right">
      ...
      <div className="halo-flexible-panel__content">
        {renderContent()}
      </div>
    </div>
  );
