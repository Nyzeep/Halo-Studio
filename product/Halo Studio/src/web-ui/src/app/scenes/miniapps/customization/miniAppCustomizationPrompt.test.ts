...
describe('buildMiniAppCustomizationPrompt', () => {
  it('includes draft root and active-app write warning', () => {
    const prompt = buildMiniAppCustomizationPrompt({
      ...
      appName: 'Gomoku',
      draftId: 'draft-1',
      draftRoot: 'C:/Users/me/AppData/Roaming/Halo/miniapps/.drafts/builtin-gomoku/draft-1',
      userRequest: 'Make the board lighter',
    });

    expect(prompt).toContain('Draft root: C:/Users/me/AppData/Roaming/Halo/miniapps/.drafts/builtin-gomoku/draft-1');
