/**
 * Halo chat-input mascot — sleeping panda (user-authored SVG geometry).
 *
...
function Silhouette() {
  return (
    <g className="halo-panda-head__silhouette" aria-hidden>
      {/* Ears + back-hump bump */}
      <g className="halo-panda-head__ears">
        <g className="halo-panda-head__ear halo-panda-head__ear--left">
          <ellipse cx={50} cy={70} rx={29} ry={29} className="halo-panda__b" />
        </g>
        <g className="halo-panda-head__ear halo-panda-head__ear--right">
          <ellipse cx={181} cy={42} rx={28} ry={27} className="halo-panda__b" />
        </g>
      </g>
      <ellipse
        cx={259}
      ...
      <g className="halo-panda-head__body halo-panda-head__body--front">
        <path
          className="halo-panda__b"
      ...
      {/* White face */}
      <path
        className="halo-panda__face-mask"
      ...
      <g className="halo-panda-head__paw halo-panda-head__paw--front">
        <path
          className="halo-panda__b"
          d="M22 142 C39 129 72 130 97 142 C111 149 113 162 102 171 C87 184 49 181 27 170 C11 162 10 151 22 142Z"
        />
      </g>
      <g className="halo-panda-head__paw halo-panda-head__paw--rear">
        <path
          className="halo-panda__b"
      ...
      <g className="halo-panda-head__muzzle">
        <path
          className="halo-panda__face-mask"
...
function FaceRest() {
  return (
    <g className="halo-panda-head__face halo-panda-head__face--rest">
      <g className="halo-panda-head__zzz" aria-hidden>
        <text
          x={215}
          y={75}
          className="halo-panda-head__zzz-glyph halo-panda-head__zzz-glyph--a"
        >
          z
        </text>
        <text
          x={245}
          y={45}
          className="halo-panda-head__zzz-glyph halo-panda-head__zzz-glyph--b"
        >
          z
        </text>
        <text
          x={278}
          y={18}
          className="halo-panda-head__zzz-glyph halo-panda-head__zzz-glyph--c"
        >
          Z
        </text>
      </g>
...
function FaceAnalyzing() {
  return (
    <g className="halo-panda-head__face halo-panda-head__face--analyze">
      <g className="halo-panda-head__think" aria-hidden>
        <circle cx={222} cy={72} r={4.5} className="halo-panda__b halo-panda-head__think-pip" />
        <circle cx={250} cy={48} r={6} className="halo-panda__b halo-panda-head__think-pip" />
        <circle cx={282} cy={20} r={8} className="halo-panda__b halo-panda-head__think-pip" />
      </g>
    </g>
  );
}
...
function FaceWaiting() {
  return (
    <g className="halo-panda-head__face halo-panda-head__face--wait">
      <g className="halo-panda-head__wait-pips" aria-hidden>
        <circle cx={228} cy={50} r={5} className="halo-panda-head__wait-pip" />
        <circle cx={252} cy={50} r={5} className="halo-panda-head__wait-pip" />
        <circle cx={276} cy={50} r={5} className="halo-panda-head__wait-pip" />
      </g>
    </g>
  );
}
...
function FaceWorking() {
  return (
    <g className="halo-panda-head__face halo-panda-head__face--work">
      {/* Sweat drop trickling down from forehead — classic "trying hard" cue. */}
      <g className="halo-panda-head__sweat" aria-hidden>
        <path
          d="M210 50 C204 60 204 72 210 76 C216 72 216 60 210 50 Z"
          className="halo-panda-head__sweat-drop"
        />
      </g>
    </g>
  );
...
function FaceHover() {
  return (
    <g className="halo-panda-head__face halo-panda-head__face--hover">
      <g className="halo-panda-head__sparkles" aria-hidden>
        <path d="M226 46 L232 58 L244 64 L232 70 L226 82 L220 70 L208 64 L220 58 Z" className="halo-panda-head__sparkle halo-panda-head__sparkle--a" />
        <path d="M270 20 L274 28 L282 32 L274 36 L270 44 L266 36 L258 32 L266 28 Z" className="halo-panda-head__sparkle halo-panda-head__sparkle--b" />
      </g>
    </g>
  );
}
...
function FaceDragging() {
  return (
    <g className="halo-panda-head__face halo-panda-head__face--drag">
      <g className="halo-panda-head__drag-lines" aria-hidden>
        <path d="M226 48 C244 40 262 40 282 48" className="halo-panda-head__drag-line halo-panda-head__drag-line--a" />
        <path d="M230 72 C248 64 268 65 286 75" className="halo-panda-head__drag-line halo-panda-head__drag-line--b" />
      </g>
    </g>
  );
}
...
export const ChatInputPixelPet: React.FC<ChatInputPixelPetProps> = ({
  ...
  const layoutMod =
    layout === 'stopRight' ? ' halo-chat-input-pixel-pet--layout-stop-right' : '';
  ...
  const stageClasses = [
    'halo-chat-input-pixel-pet__stage',
    `halo-chat-input-pixel-pet__stage--${mood}`,
    transitioning ? 'halo-chat-input-pixel-pet__stage--transition' : '',
    idleAction ? `halo-chat-input-pixel-pet__stage--idle-${idleAction}` : '',
  ]
    .filter(Boolean)
    .join(' ');
  ...
  if (pet && petSrc) {
    ...
    const nativePetdexStyle = nativePetdexSize && petFrameSize
      ? {
        '--halo-petdex-width': `${petFrameSize.width}px`,
        '--halo-petdex-height': `${petFrameSize.height}px`,
      }
      : {};
    return (
      <div
        className={`halo-chat-input-pixel-pet${layoutMod} ${className}`.trim()}
        style={nativePetdexStyle as React.CSSProperties}
        aria-hidden
      >
        <div
          className={`halo-chat-input-pixel-pet__petdex halo-chat-input-pixel-pet__petdex--${mood}`}
          style={{
            '--halo-petdex-src': `url("${petSrc}")`,
            '--halo-petdex-row': rowByMood[mood],
  ...
  if (pet) {
    return (
      <div className={`halo-chat-input-pixel-pet${layoutMod} ${className}`.trim()} aria-hidden />
    );
  }
  ...
  return (
    <div className={`halo-chat-input-pixel-pet${layoutMod} ${className}`.trim()} aria-hidden>
      <div className={stageClasses}>
        <svg
          className={`halo-chat-input-pixel-pet__svg halo-chat-input-pixel-pet__svg--${mood}`}
        ...
        >
          ...
          <g className={`halo-panda-head halo-panda-head--${mood}`}>
            <Silhouette />
            <g className="halo-panda-head__faces">
              {FACE_ORDER.map(m => (
                <g
                  key={m}
                  className="halo-panda-head__face-layer"
