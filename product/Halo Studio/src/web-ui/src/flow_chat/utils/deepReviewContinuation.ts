...
const RESULT_RECOVERY_MESSAGES: Record<DeepReviewResultRecoveryReason, string> = {
  missing_submit_code_review:
    'Strict review completed, but Halo did not receive a structured submit_code_review result.',
  invalid_submit_code_review:
    'Strict review submitted a structured result that Halo could not read.',
  wrong_review_mode:
