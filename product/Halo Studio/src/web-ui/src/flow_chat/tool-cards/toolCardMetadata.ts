...
export const TOOL_CARD_CONFIGS: Record<string, ToolCardConfig> = {
  ...
  'PageDeploy': {
    ...
    requiresConfirmation: false,
    resultDisplayType: 'detailed',
    description: 'Deploy a saved Halo Studio Page version to production',
    displayMode: 'standard',
    primaryColor: UI_EXCEPTION_ACCENTS.toolIdentity.terminal
  },
  'PagePublish': {
    ...
    resultDisplayType: 'detailed',
    description: 'Publish Halo Studio Page content (upload, save version, deploy)',
    displayMode: 'standard',
    primaryColor: UI_EXCEPTION_ACCENTS.toolIdentity.terminal
  },
  'GenerativeUI': {
  ...
  'CreateCanvas': {
    ...
    requiresConfirmation: false,
    resultDisplayType: 'detailed',
    description: 'Create a Halo Studio Canvas artifact',
    displayMode: 'detailed',
    primaryColor: UI_EXCEPTION_ACCENTS.generativeUi
  },
  'ReadCanvas': {
    ...
    requiresConfirmation: false,
    resultDisplayType: 'detailed',
    description: 'Read a Halo Studio Canvas artifact',
    displayMode: 'detailed',
    primaryColor: UI_EXCEPTION_ACCENTS.generativeUi
  },
  'UpdateCanvas': {
    ...
    requiresConfirmation: false,
    resultDisplayType: 'detailed',
    description: 'Update a Halo Studio Canvas artifact',
    displayMode: 'detailed',
    primaryColor: UI_EXCEPTION_ACCENTS.generativeUi
  },
  'PatchCanvas': {
    ...
    requiresConfirmation: false,
    resultDisplayType: 'detailed',
    description: 'Patch a Halo Studio Canvas artifact',
    displayMode: 'detailed',
    primaryColor: UI_EXCEPTION_ACCENTS.generativeUi
  },
};
