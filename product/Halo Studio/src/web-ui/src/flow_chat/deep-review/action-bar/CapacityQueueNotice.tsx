...
const CAPACITY_QUEUE_REASON_DETAIL_KEYS: Record<DeepReviewCapacityQueueReason, {
  ...
  provider_rate_limit: {
    ...
    defaultValue: 'The model provider is rate-limiting requests. Halo will wait briefly and continue when capacity returns.',
  },
  provider_concurrency_limit: {
    key: 'deepReviewActionBar.capacityQueue.reasonDetails.providerConcurrencyLimit',
    defaultValue: 'The model provider rejected another concurrent review request. Halo will retry after capacity opens.',
  },
  retry_after: {
    key: 'deepReviewActionBar.capacityQueue.reasonDetails.retryAfter',
    defaultValue: 'The model provider asked Halo to retry later. Waiting here avoids spending Review work while the provider cools down.',
  },
  ...
  temporary_overload: {
    ...
    defaultValue: 'The model provider reported temporary overload. Halo will wait briefly and then continue or reduce coverage.',
  },
};
