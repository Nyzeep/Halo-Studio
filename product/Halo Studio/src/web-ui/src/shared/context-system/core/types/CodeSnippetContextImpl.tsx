...
export class CodeSnippetCardRenderer implements ContextCardRenderer<'code-snippet'> {
  ...
  render(context: CodeSnippetContext, options?: RenderOptions): React.ReactNode {
    ...
    return (
      <div className={`halo-context-card halo-context-card--code-snippet ${compact ? 'halo-context-card--compact' : ''}`}>
        ...
        <div className="halo-context-card__content">
          <div className="halo-context-card__title">
            {context.fileName}
            <span className="halo-context-card__badge">
          ...
          {!compact && (
            <>
              ...
              {showPreview && (
                <div className="halo-context-card__preview">
                  <code className="halo-context-card__code">
                    {previewText}
                  </code>
                </div>
              )}
        ...
        {interactive && (
          <div className="halo-context-card__actions">
            <button 
              className="halo-context-card__action-btn"
