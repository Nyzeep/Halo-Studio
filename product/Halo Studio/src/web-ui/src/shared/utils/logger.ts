...
const CONSOLE_FORWARD_INSTALLED = '__halo_console_forward_installed__';
...
declare global {
  ...
  var __HALO_BOOTSTRAP_LOG_LEVEL__: string | undefined;
}
...
function initialLogLevel(): LogLevel {
  const bootstrapLevel = logLevelFromString(globalThis.__HALO_BOOTSTRAP_LOG_LEVEL__);
