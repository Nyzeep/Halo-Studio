...
export class ShortcutManager {
  ...
  private isInputContext(event: KeyboardEvent): boolean {
    ...
    if (
      target.classList.contains('halo-chat-input') ||
      target.classList.contains('rich-text-input') ||
      target.closest('.halo-chat-input') !== null ||
   ...
   * or with app-scope shortcuts. App-scope shortcuts are active globally inside Halo,
