export const MOUSE_GLOW_STORAGE_KEY = 'halo:appearance:mouse-glow-enabled';
export const DEFAULT_MOUSE_GLOW_ENABLED = true;

const MOUSE_GLOW_OVERLAY_ID = 'halo-mouse-glow-overlay';
...
export class MouseGlowService {
  ...
  private ensureOverlay(): HTMLDivElement {
    ...
    overlay.className = 'halo-mouse-glow-overlay';
