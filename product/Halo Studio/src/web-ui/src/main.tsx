...
async function initializeBeforeRender(): Promise<void> {
  ...
  log.info('Initializing Halo Studio');
...
async function initializeAfterRender(): Promise<void> {
  ...
  log.info('Halo Studio core systems initialized successfully');
  logElapsed(log, 'Startup phase completed', phaseStartedAt, {
...
async function startApplication(): Promise<void> {
  ...
  try {
    ...
    log.error('Failed to initialize Halo Studio (pre-render)', error);
  }
