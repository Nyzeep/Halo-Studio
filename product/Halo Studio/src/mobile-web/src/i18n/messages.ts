...
export const messages: Record<MobileLanguage, MessageTree> = {
  'en-US': {
    ...
    pairing: {
      ...
      enterAccountToContinue: 'Enter your Halo account to continue',
      ...
      accountNote: 'Use the same Halo account currently logged in on the scanned desktop. Your password is not saved on this phone.',
    ...
    chat: {
      ...
      collapsedInputPlaceholder: 'Ask Halo...',
    ...
    devices: {
      title: 'Devices',
      noDelegatedIdentity: 'The paired desktop is not logged into a Halo account. Log in on the desktop to enable multi-device control, then retry.',
      loading: 'Loading...',
      refresh: 'Refresh',
      retry: 'Retry',
  ...
  'zh-CN': {
    ...
    pairing: {
      ...
      enterAccountToContinue: '请输入你的 Halo 账号继续',
      ...
      accountNote: '请使用被扫码桌面端当前登录的 Halo 账号。密码不会保存在本机。',
      connecting: '连接中...',
    ...
    devices: {
      title: '设备',
      noDelegatedIdentity: '所连接的桌面端未登录 Halo 账号。请在桌面端登录以启用多设备控制，然后重试。',
      loading: '加载中...',
      refresh: '刷新',
      retry: '重试',
      noDevices: '未找到设备',
  ...
  'zh-TW': {
    ...
    pairing: {
      ...
      enterAccountToContinue: '請輸入你的 Halo 帳號繼續',
      ...
      accountNote: '請使用被掃碼桌面端目前登入的 Halo 帳號。密碼不會保存在本機。',
      connecting: '連接中...',
    ...
    devices: {
      title: '設備',
      noDelegatedIdentity: '所連接的桌面端未登入 Halo 帳號。請在桌面端登入以啟用多設備控制，然後重試。',
      loading: '加載中...',
      refresh: '重新整理',
      retry: '重試',
      noDevices: '未找到設備',
