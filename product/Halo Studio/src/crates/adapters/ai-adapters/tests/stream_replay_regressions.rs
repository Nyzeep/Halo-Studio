...
use halo_agent_stream::StreamResult;
use halo_ai_adapters::providers::{openai::OpenAIMessageConverter, AnthropicMessageConverter};
use halo_ai_adapters::{Message as AIMessage, ToolCall as AIToolCall};
