...
pub use halo_core_types::{ConnectionTestMessageCode, ConnectionTestResult, RemoteModelInfo};
...
impl From<halo_agent_stream::UnifiedTokenUsage> for GeminiUsage {
    fn from(usage: halo_agent_stream::UnifiedTokenUsage) -> Self {
        Self {
...
impl From<GeminiUsage> for halo_agent_stream::UnifiedTokenUsage {
...
mod tests {
    ...
    fn gemini_usage_converts_to_and_from_unified_token_usage() {
        ...
        let unified: halo_agent_stream::UnifiedTokenUsage = usage.clone().into();
