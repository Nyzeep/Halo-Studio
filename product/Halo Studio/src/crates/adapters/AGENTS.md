...
| `pi-rpc-adapter` | Sole Halo P0 Workbench Runtime projection for the controlled local `pi --mode rpc` LF JSONL contract; owns process, protocol, extension, redaction, and cleanup details | inherited |
