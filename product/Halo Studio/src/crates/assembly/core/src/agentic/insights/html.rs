...
impl HtmlLabels {
    ...
    pub fn en() -> Self {
        HtmlLabels {
            ...
            section_usage: "How You Use Halo",
            ...
            md_additions: "Halo.md Additions",
...
fn render_suggestions(suggestions: &InsightsSuggestions, l: &HtmlLabels) -> String {
    ...
    if !suggestions.halo_md_additions.is_empty() {
