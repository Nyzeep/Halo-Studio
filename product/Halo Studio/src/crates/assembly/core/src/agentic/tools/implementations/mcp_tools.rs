...
fn tool_error(message: impl Into<String>) -> HaloError {
    HaloError::tool(message.into())
}
...
async fn get_mcp_server_manager() -> HaloResult<Arc<MCPServerManager>> {
