...
The folder `{MEMORY_ROOT}/` is a git repository managed by Halo Studio. Read
`phase2_workspace_diff.md` in this same folder first. It contains the git-style diff from
the previous successful Phase 2 baseline to the current worktree. It is generated by Halo Studio for
...
- Typical workflows and tools (how they like to work, how they use Halo Studio/agents, preferred formats)
