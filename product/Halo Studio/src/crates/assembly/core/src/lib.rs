...
//! This crate re-exports legacy paths and wires the full Halo product runtime.
...
// Export main types
pub use halo_runtime_ports as runtime_ports;
pub use util::errors::*;
pub use util::types::*;
...
pub const CORE_NAME: &str = "Halo Core";
