...
//! `halo-services-core`; core only supplies the product-managed runtime root.

use crate::infrastructure::get_path_manager_arc;
use crate::util::errors::HaloResult;
use halo_services_core::managed_runtime::ManagedRuntimeResolver;
use std::path::{Path, PathBuf};

pub use halo_services_core::managed_runtime::{
...
mod tests {
    ...
    fn temp_runtime_root() -> PathBuf {
        ...
        let id = format!(
            "halo-core-runtime-adapter-test-{}-{}",
            std::process::id(),
