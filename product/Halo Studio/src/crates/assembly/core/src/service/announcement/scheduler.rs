...
impl AnnouncementScheduler {
    ...
    pub async fn new(path_manager: &Arc<PathManager>) -> HaloResult<Self> {
    ...
    pub async fn run(&self, locale: &str) -> HaloResult<Vec<AnnouncementCard>> {
    ...
    pub async fn mark_seen(&self, id: &str) -> HaloResult<()> {
        {
            let mut state = self.state.write().await;
    ...
    pub async fn dismiss(&self, id: &str) -> HaloResult<()> {
        {
            let mut state = self.state.write().await;
    ...
    pub async fn never_show(&self, id: &str) -> HaloResult<()> {
        {
            let mut state = self.state.write().await;
    ...
    async fn save_current_state(&self) -> HaloResult<()> {
