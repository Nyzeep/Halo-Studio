...
name: docs-canvas
description: >-
  Render a documentation-style Halo Studio Canvas that organizes architecture
...
Read `halo-canvas` first. It contains the generation policy, design guidance, slop rules, self-check, Canvas runtime rules, and SDK usage notes.
