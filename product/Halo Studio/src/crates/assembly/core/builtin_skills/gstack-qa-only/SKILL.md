...
When this skill is invoked by Halo Studio Team Mode, this skill supplies the report-only QA methodology. Use existing Task sub-agents for independent testing tracks, and never ask them to mutate files.
...
| Mode | full | `--quick`, `--regression .halo-studio/team/qa-reports/baseline.json` |
...
```bash
REPORT_DIR=".halo-studio/team/qa-reports"
