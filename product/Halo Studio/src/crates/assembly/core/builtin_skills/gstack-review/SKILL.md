...
description: |
  ...
  handled by Halo Studio's unified Review mechanism instead. (gstack)
---
...
When this skill is invoked by Halo Studio Team Mode, this skill supplies the pre-landing review lens. Use existing Task sub-agents for independent diff review tracks, then consolidate findings in the main Team session.
...
If A: address the findings. Re-run `Halo Studio Task outside-voice review` to verify.
