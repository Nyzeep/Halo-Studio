/**
 * UI primitives for `halo/canvas`. Styling follows the Halo dark theme; no extra packages required.
 */
...
export type CardProps = {
    ...
    variant?: CardVariant;
    /** `lg` uses a taller header and roomier title padding (matches Halo UI). */
    size?: CardSize;
    /**
 ...
 * renders a status icon matching `Halo UI` toasts (override with `icon`).
 *
 * @example
 * ```tsx
