...
struct ProductShapeSubmissionPort {
    submitted_turns: Mutex<Vec<halo_runtime_ports::AgentSubmissionRequest>>,
}

#[async_trait]
impl halo_runtime_ports::AgentSubmissionPort for ProductShapeSubmissionPort {
    async fn create_session(
        &self,
        request: halo_runtime_ports::AgentSessionCreateRequest,
    ) -> PortResult<halo_runtime_ports::AgentSessionCreateResult> {
        Ok(halo_runtime_ports::AgentSessionCreateResult::new(
    ...
    ) -> PortResult<halo_runtime_ports::AgentSubmissionResult> {
...
fn product_full_services() -> halo_runtime_services::RuntimeServices {
...
fn baseline_services() -> halo_runtime_services::RuntimeServices {
    FakeRuntimeServicesProvider::with_all_required()
        .build_services()
