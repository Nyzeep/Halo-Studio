// Halo backend adapter for PPT Live.
//
// The MiniApp agent bridge (`app.agent.*`) is the only generation path. A
// single cowork agent turn loads Halo's pinned built-in `ppt-design` skill
...
export function installHaloBackendAdapter(app = window.app) {
