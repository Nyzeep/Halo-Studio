...
// Halo host accent (cool blue) so the dominant language reads as primary;
...
const I18N = {
  'zh-CN': {
    ...
    errNoWs: '还没有打开工作区',
    errNoWsDesc: '请先在 Halo 侧边栏选择一个 Git 仓库的工作区。',
  ...
  'zh-TW': {
    ...
    errNoWs: '還沒有打開工作區',
    errNoWsDesc: '請先在 Halo 側邊欄選擇一個 Git 倉庫的工作區。',
  ...
  'en-US': {
    ...
    errNoWsDesc: 'Open a Git repo workspace from the Halo sidebar first.',
