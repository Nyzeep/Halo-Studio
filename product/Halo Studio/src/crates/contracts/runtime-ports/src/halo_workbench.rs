...
//! Commands and events use only Halo-local identifiers plus explicitly
//! redacted tool-call identifiers for permission correlation.
...
pub const PI_RPC_ADAPTER_IDENTITY: &str = "pi-rpc";
