...
`halo-events` owns platform-neutral event contracts and the emitter interface.
...
- Use shared DTOs from `halo-core-types` when event payloads need stable
