use halo_services_core::diff::{DiffConfig, DiffLineType, DiffService};
use halo_services_core::system::check_command;
...
fn system_check_command_preserves_missing_command_shape() {
    let result = check_command("__halo_missing_command_for_services_core_test__");
