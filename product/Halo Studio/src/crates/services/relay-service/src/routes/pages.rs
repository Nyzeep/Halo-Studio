//! Halo Page: versioned publish + Page Functions serve.
//!
...
use halo_page_function_runtime::{
...
const PAGE_ACCESS_COOKIE: &str = "halo_page_access";
...
<head>
  ...
  <title>需要登录 · Halo Page</title>
  <style>{}</style>
</head>
<body>
  <main>
    <div class="mark" aria-hidden="true">B</div>
    <p class="eyebrow">HALO PAGE</p>
    <h1>登录后访问</h1>
    <p>此页面受访问权限保护，请使用 Halo 账号登录。</p>
    <p class="secondary">This Page is protected. Sign in with your Halo account.</p>
