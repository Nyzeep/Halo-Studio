...
请在 Halo 桌面端打开 Remote Connect 面板，复制 6 位配对码并发送到这里完成连接。",
    paired_success: "配对成功，Halo 已连接。",
    need_pairing: "尚未连接 Halo 桌面端。请先发送 6 位配对码。",
    ...
    main_title_assistant: "Halo · 助理模式",
    main_title_expert: "Halo · 专业模式",
    settings_title: "设置",
    welcome_title: "Halo",
    ...
    switch_no_workspaces: "尚未发现工作区，请先在 Halo 桌面端打开一个项目。",
    switch_no_assistants: "尚未发现助理，请先在 Halo 桌面端创建一个助理。",
    current_marker: " · 当前",
    ...
    switch_model_no_models: "没有可用的模型，请先在 Halo 桌面端配置 AI 模型。",
    ...
    session_system_unavailable: "Halo 会话系统尚未就绪，请稍后再试。",
    ...
    devices_title: "多设备控制",
    devices_account_required: "所连接的桌面端尚未登录 Halo 账号，无法使用多设备控制。请在桌面端的账号登录对话框中登录，机器人会自动继承账号身份。",
...
請在 Halo 桌面端打開 Remote Connect 面板，複製 6 位配對碼併發送到這裡完成連接。",
    paired_success: "配對成功，Halo 已連接。",
    need_pairing: "尚未連接 Halo 桌面端。請先發送 6 位配對碼。",
    ...
    switch_no_workspaces: "尚未發現工作區，請先在 Halo 桌面端打開一個項目。",
    switch_no_assistants: "尚未發現助理，請先在 Halo 桌面端創建一個助理。",
    current_marker: " · 當前",
    ...
    switch_model_no_models: "沒有可用的模型，請先在 Halo 桌面端配置 AI 模型。",
    ...
    session_system_unavailable: "Halo 會話系統尚未就緒，請稍後再試。",
    ...
    devices_title: "多裝置控制",
    devices_account_required: "所連接的桌面端尚未登入 Halo 帳號，無法使用多裝置控制。請在桌面端的帳號登入對話框中登入，機器人會自動繼承帳號身份。",
...
Open Remote Connect in Halo Desktop and send the 6-digit pairing code here to connect.",
    paired_success: "Pairing successful. Halo is now connected.",
    need_pairing: "Not connected yet. Please send the 6-digit pairing code first.",
    invalid_pairing_code: "Invalid or expired pairing code. Generate a new one in Halo Desktop and try again.",
    ...
    main_title_assistant: "Halo · Assistant",
    main_title_expert: "Halo · Expert",
    ...
    switch_no_workspaces: "No workspaces found. Open a project in Halo Desktop first.",
    switch_no_assistants: "No assistants found. Create one in Halo Desktop first.",
    ...
    switch_model_no_models: "No models available. Please configure AI models in Halo Desktop first.",
    ...
    session_system_unavailable: "Halo session system is not ready yet.",
    ...
    auto_push_skip_too_large_fmt: "Skipping \"{name}\": {size} exceeds the {limit} limit. Please grab it from Halo Desktop instead.",
    auto_push_failed_fmt: "Failed to send \"{name}\": {err}",

    devices_title: "Multi-device Control",
    devices_account_required: "The paired desktop is not logged into a Halo account, so multi-device control is unavailable. Log in via the desktop's Account Login dialog and the bot will inherit the account identity.",
