...
pub struct PairingResponse {
    ...
    /// Local pairing user id, or Halo account username when account auth is required.
    #[serde(default)]
    pub user_id: Option<String>,
    /// Halo account password when the paired desktop is logged in. Never log this field.
    #[serde(default)]
