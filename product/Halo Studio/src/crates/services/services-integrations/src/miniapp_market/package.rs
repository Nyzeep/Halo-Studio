...
use halo_product_domains::miniapp::types::MiniApp;
...
mod tests {
    use super::*;
    use halo_product_domains::miniapp::types::{MiniAppPermissions, NodePermissions};
    ...
    fn generated_package_roundtrips_through_strict_validator() {
        let app = MiniApp {
            ...
            created_at: 1,
            updated_at: 2,
            source: halo_product_domains::miniapp::types::MiniAppSource {
