...
Use this guide to pair Halo Studio through a Feishu bot.
...
Open Halo Studio and start the Feishu bot connection:
...
Enter the 6-digit pairing code shown in Halo Studio Desktop, send it, and wait for the connection to succeed.
