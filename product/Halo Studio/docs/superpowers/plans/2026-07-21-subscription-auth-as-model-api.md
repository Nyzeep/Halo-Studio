...
**Goal:** Let Halo Studio sign in to Codex / Antigravity / OpenCode subscriptions and use them as model API auth, aligned with OpenCode.

**Architecture:** `subscription_auth` store + OAuth login sessions in `halo-ai-adapters`; `AuthConfig::Subscription`; desktop Tauri + AIModelConfig UI.
