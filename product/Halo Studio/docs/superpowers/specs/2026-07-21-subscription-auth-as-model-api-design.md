...
Align Halo Studio with OpenCode’s “use another product’s subscription as a model API”
capability. Users sign in to Codex (ChatGPT), Antigravity (Google), or OpenCode
Zen inside Halo Studio; the resulting OAuth tokens authenticate AI requests. No
...
UI (AIModelConfig)
  ...
  -> halo-ai-adapters::subscription_auth
...
- `cargo test -p halo-ai-adapters --features subscription-auth subscription_auth`
