...
交付物图谱是复杂项目的后台关系层。它让 Halo Studio 在解释变更、准备 PR、发布、复盘或评估时，回答“这次变更和哪些工程资产有关，证据是否新鲜，关系是谁确认的”。
...
- 目标项目已有的 Jira、Linear、GitHub、CI 或观测系统保留系统主权，Halo Studio 只做适配和投影。
