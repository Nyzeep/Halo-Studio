...
pub(crate) struct InstallOptions {
    ...
    /// First-launch theme preference (`system` or Halo built-in theme id)
...
impl From<halo_ai_adapters::types::RemoteModelInfo> for RemoteModelInfo {
    fn from(value: halo_ai_adapters::types::RemoteModelInfo) -> Self {
        Self {
            id: value.id,
...
impl From<halo_ai_adapters::types::ConnectionTestMessageCode> for ConnectionTestMessageCode {
    fn from(value: halo_ai_adapters::types::ConnectionTestMessageCode) -> Self {
        match value {
            halo_ai_adapters::types::ConnectionTestMessageCode::ToolCallsNotDetected => {
                Self::ToolCallsNotDetected
            }
            halo_ai_adapters::types::ConnectionTestMessageCode::ImageInputCheckFailed => {
                Self::ImageInputCheckFailed
            }
            halo_ai_adapters::types::ConnectionTestMessageCode::TlsOrCertificateIssue => {
                Self::TlsOrCertificateIssue
            }
            halo_ai_adapters::types::ConnectionTestMessageCode::ProxyIssue => Self::ProxyIssue,
            halo_ai_adapters::types::ConnectionTestMessageCode::NetworkIssue => {
                Self::NetworkIssue
            }
        }
    }
...
impl From<halo_ai_adapters::types::ConnectionTestResult> for ConnectionTestResult {
    fn from(value: halo_ai_adapters::types::ConnectionTestResult) -> Self {
        Self {
