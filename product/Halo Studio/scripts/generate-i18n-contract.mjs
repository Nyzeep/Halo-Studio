...
const outputs = [
  ...
  {
    path: path.join(root, 'Halo-Installer', 'src', 'i18n', 'generatedLocaleContract.ts'),
  ...
  {
    path: path.join(root, 'Halo-Installer', 'src-tauri', 'src', 'installer', 'generated_locale_contract.rs'),
