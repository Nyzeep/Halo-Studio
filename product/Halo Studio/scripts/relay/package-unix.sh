...
SERVER="${RELEASE_DIR}/halo-relay-server"
ADMIN="${RELEASE_DIR}/relay-admin"
STAGE_NAME="halo-relay-server-${VERSION}-${TARGET}"
...
ARCHIVE_NAME="halo-relay-server-${TARGET}.tar.gz"
...
smoke_server "$EXTRACTED/halo-relay-server"
