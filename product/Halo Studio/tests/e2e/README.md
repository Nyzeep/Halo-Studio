...
# Halo Studio E2E Tests

E2E test framework using WebDriverIO + the embedded Halo Studio WebDriver.
...
The test runner starts Halo Studio directly and waits for the embedded WebDriver service on `127.0.0.1:4445`.
