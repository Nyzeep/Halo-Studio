...
describe('L1 File Tree', () => {
  ...
  before(async () => {
    ...
    if (hasWorkspace) {
      ...
      const fileNavSelectors = [
        '//button[contains(@class, "halo-nav-panel__item")]//span[contains(text(), "Files")]/..',
        '//button[contains(@class, "halo-nav-panel__item")]//span[contains(text(), "文件")]/..',
        '.halo-nav-panel__item[aria-label*="Files"]',
        '.halo-nav-panel__item[aria-label*="文件"]',
        'button.halo-nav-panel__item:first-child', // Files is usually first
      ];
  ...
  describe('File tree existence', () => {
    it('file tree container should be visible', async function () {
      ...
      if (!treeFound) {
        ...
        const fileExplorer = await $('.halo-file-explorer, .halo-explorer-scene, [class*="Explorer"]');
    ...
    it('file tree should display workspace files', async function () {
      ...
      const fileNodes = await browser.$$('.halo-file-explorer__node');
  ...
  describe('Folder expand/collapse', () => {
    ...
    it('clicking directory should toggle expand state', async function () {
      ...
      const dirContent = await browser.$$('.halo-file-explorer__node-content');
  ...
  describe('File selection', () => {
    it('clicking file should select it', async function () {
      ...
      const content = await firstFile.$('.halo-file-explorer__node-content');
    ...
    it('selected file should have selected class', async function () {
      ...
      const selectedNodes = await browser.$$('.halo-file-explorer__node-content--selected');
