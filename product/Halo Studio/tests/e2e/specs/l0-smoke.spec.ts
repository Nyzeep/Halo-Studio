...
describe('L0 Smoke Tests', () => {
  ...
  describe('Core UI components', () => {
    it('Header should be visible', async () => {
      ...
      const header = await $('.halo-nav-panel, .halo-scene-bar, .halo-nav-bar, [data-testid="header-container"]');
    ...
    it('should have either startup page or workspace UI', async () => {
      ...
      if (!welcomeExists) {
        ...
        const sceneViewport = await $('.halo-scene-viewport');
