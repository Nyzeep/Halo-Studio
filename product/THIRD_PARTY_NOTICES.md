...
Halo Studio carries the pinned BitFun source tree under `product/bitfun/`. This
index keeps the upstream license evidence discoverable without changing the
upstream source files.

## BitFun

- MIT license and the upstream copyright notice: `product/bitfun/LICENSE`
...
- `product/bitfun/src/crates/assembly/core/builtin_skills/docx/LICENSE.txt`
- `product/bitfun/src/crates/assembly/core/builtin_skills/pdf/LICENSE.txt`
- `product/bitfun/src/crates/assembly/core/builtin_skills/ppt-design/LICENSE.txt`
- `product/bitfun/src/crates/assembly/core/builtin_skills/pptx/LICENSE.txt`
- `product/bitfun/src/crates/assembly/core/builtin_skills/xlsx/LICENSE.txt`
- `product/bitfun/src/crates/execution/tool-call-jsonrepair/LICENSE`
- `product/bitfun/src/web-ui/public/fonts/FiraCode/LICENSE.txt`
- `product/bitfun/src/web-ui/public/fonts/Noto_Sans_SC/variable/LICENSE.txt`
...
The presence of source-only BitFun modules under `product/bitfun/` does not
