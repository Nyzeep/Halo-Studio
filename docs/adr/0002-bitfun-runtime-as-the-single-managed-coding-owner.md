---
status: superseded by ADR-0071 for execution ownership
---
...
ADR-0071 调整了 P0 所有权：OpenCode 拥有 Provider、模型、原生 Session 与 Agent 工具循环；Halo Workbench Runtime 拥有工作区信任、受管任务状态、决议、证据和生命周期投影。仍不允许旧 Sidecar、ACP 或前端形成并行权威。
