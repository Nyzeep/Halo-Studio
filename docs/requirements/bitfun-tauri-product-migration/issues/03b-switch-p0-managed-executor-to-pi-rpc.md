...
**Blocked by:** 03A1 - 接入 BitFun 正式 Web UI 并完成 Halo 品牌适配.
...
pi --version
rg -n '03B|03b' docs/requirements/bitfun-tauri-product-migration/README.md docs/requirements/bitfun-tauri-product-migration/issues
```
